[ModelTest](http://qt-project.org/wiki/Model_Test) is a part of the Qt test suite that provides a way to check for common errors in implementations of QAbstractItemModel.
